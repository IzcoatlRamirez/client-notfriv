...
const ListItem: React.FC<Collaborator> = ({ name, cvLink }) => (
  <li style={{ marginBottom: '15px', fontSize: '24px', display: 'flex', alignItems: 'center' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', flex: '1', justifyContent: 'space-between', paddingRight: '1000px' }}>
      <span style={{ color: 'white', fontFamily: 'optima' }}>{name}</span>
      <a
        style={{
          color: 'white',
          textDecoration: 'none',
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography variant="h1" style={{ color: "#05166C", fontFamily: "monaco" }}>
            Colaboradores
          </Typography>
        </Box>

        <Typography variant="h4" sx={{ color: "#070301", fontWeight: 'bold', fontSize: 30, fontFamily: "Times" }}>
          PROJECT MANAGER<br /><br />
        </Typography>
        <Typography variant="h5" sx={{ color: "white", fontFamily: "optima", marginLeft: '10px'  }}>
        <span style={{ color: '#05166C', fontWeight: 'bold', fontSize: '32px', verticalAlign: 'middle', marginRight: '10px' }}>•</span>Angel Ignacio Ortega Vega <a style={{ color: "white", textDecoration: 'none', marginLeft: '10px', padding: '5px 10px', borderRadius: '5px', backgroundColor: '#05166C', fontFamily: "geneva"}} href="https://angelortega03.github.io/">Consultar CV<br /></a>
        </Typography><br /><br />
        <Typography variant="h4" sx={{ color: "#070301", fontWeight: 'bold', fontSize: 30, fontFamily: "Times" }}>
